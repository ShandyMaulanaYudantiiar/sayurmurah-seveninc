...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page">Edit Pasar</li>
@endsection
                ...
                <div class="card bg-white">
                    <div class="card-header bg-transparent">
                        <div class="row align-items-center">
                            <div class="col">
                                <form action="{{ route('update.pasar', $data->id_pasar) }}" method="post"
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="id_daerah" name="id_daerah">
                                                    <option value="{{ $data->nama_daerah }}">--- Pilih Daerah---</option>
                                                    {{-- @foreach ($data as $daerah)
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" type="text" name="alamat_pasar"
                                                    ...
                                                    placeholder="Masukkan alamat pasar ...">{{ $data->alamat_pasar }}</textarea>
