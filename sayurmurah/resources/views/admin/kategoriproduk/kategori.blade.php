            ...
            <div class="col-xl-12">
                <div class="card bg-white">
                    <div class="card-header bg-transparent">
                        <a href="{{ route('vtambah.kategori') }}" class="btn btn-icon btn-success" type="button">
                            ...
                            <div class="col">
                                <div class="table-responsive">
                                    <div style="overflow-y: auto;">
                                            ...
                                            <thead class="thead-light">
                                                ...
                                                @foreach ($kategori as $row)
                                                    <tr>
                                                        ...
                                                        <td>{{ $row['deskripsi_jenis_produk'] }}</td>
                                                        <td>
                                                            <img class="avatar rounded-circle mr-3"
                                                                src="{{ asset('/image/admin/jenisproduk/' . $row['foto_jenis_produk']) }}"
                                                                alt="img" width="100px">
                                                        </td>
                                                        <td><a href="{{ route('kedit.produk',$row->id_jenis_produk)}}" style="margin-bottom: 0"
                                                        ...
                                                        <a href="{{ route('delete.jproduk',$row->id_jenis_produk) }}" class="btn btn-icon btn-danger btn-rounded-circle" type="button"
                                                            onclick="confirm_modal('')" data-toggle="modal"
                                                            data-target="#deleteModal{{ $row->id_jenis_produk }}">
                                                            <span class="btn-inner--icon text-white"><i
                                        ...
                                        <!-- Delete Modal -->
                                        <div class="modal fade" id="deleteModal{{ $row->id_jenis_produk }}"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="jenis/delete/{{ $row->id_jenis_produk }}" type="button"
