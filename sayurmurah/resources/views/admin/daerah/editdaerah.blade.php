...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page">Edit Daerah</li>
@endsection
                ...
                <div class="card bg-white">
                    <div class="card-header bg-transparent">
                        <div class="row align-items-center">
                            <div class="col">
                                <form action="{{ route('update.daerah', $data->id_daerah) }}" method="POST"
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" name="nama_daerah"
                                                    id="nama_daerah" value="{{ $data->nama_daerah }}">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" name="jumlah_pasar"
                                                    id="jumlah_pasar" value="{{ $data->jumlah_pasar }}">
                                    ...
                                    <div class="form-group">
                                        <a href="{{ route('data.daerah') }}" class="btn btn-icon btn-danger" type="submit"
